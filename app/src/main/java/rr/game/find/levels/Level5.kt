...
import rr.game.find.databinding.Level5Binding
...
class Level5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = Level5Binding.inflate(layoutInflater)
        ...
        back.setOnClickListener {
            startActivity(Intent(this@Level5, MainActivity::class.java))
            finish()
        }
    ...
    private fun restart() {
        startActivity(
            Intent(this@Level5, this@Level5::class.java)
    ...
    private fun nextLvl() {
        if (timeDelay > 2000) {
            ...
            startActivity(
                Intent(this@Level5, Level8::class.java)
                    .apply {
                        putExtra(Constant.HEALTH_GIVE, healthPoint)
                        putExtra(Constant.SCORE_GIVE, scoreFinish)
                        putExtra(Constant.TIME_DELAY_GIVE, timeDelay)
